...
import uk.gov.justice.digital.hmpps.hmppsidentifyremandperiodsapi.relevantremand.service.FindHistoricReleaseDateForwardLoopService
import java.time.LocalDate

class FindHistoricReleaseDateForwardLoopServiceTest {

  private val apiClient = mock<PrisonApiClient>()

  private val service = FindHistoricReleaseDateForwardLoopService(apiClient)
